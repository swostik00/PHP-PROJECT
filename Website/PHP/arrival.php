...
<body>
        ...
        <nav>
            ...
            <div class="navigator">
                <ul>
                    ...
                    <li><a class="active" href="./arrival.php">New Arrival</a></li>
    ...
    <section id="arrival">
        <div class="box">
            ...
            <?php
                $sql = "SELECT * FROM `product` WHERE category='Arrival'";
                ...
                if($count>0)
                {
                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="number" name="quantity" value="1" min="1" max="" placeholder="Quantity" required><br>
                                <input type="hidden" name="product_image" value="<?php echo $row['file']; ?>">
                                <input type="hidden" name="product_name" value="<?php echo $row['name']; ?>">
                                <input type="hidden" name="product_price" value="<?php echo $row['price']; ?>">
                                <input type="submit" value="add to cart" name="add_to_cart" class="addCart">
                            </div>
...
<body>
    ...
    <section id="forth">
        ...
        <div class="box">
            <div class="cad">
                <img src="../images/1.jpeg" class="Product-image">
                <div class="card-body">
            ...
            <div class="cad">
                <img src="../images/2.jpeg" class="Product-image">
                <div class="card-body">
            ...
            <div class="cad">
                <img src="../images/3.jpeg" class="Product-image">
                <div class="card-body">
